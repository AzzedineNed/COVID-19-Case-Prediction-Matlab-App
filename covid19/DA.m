...
function [Best_score,Best_pos,cg_curve]=DA(SearchAgents_no,Max_iteration,lb,ub,dim,fobj,curve,app)
%temp=app2;
...
for iter=1:Max_iteration
    ...
    cg_curve(iter)=Best_score;
         ...
         tas=[tas,'At iteration ', num2str(iter), ' the MSE is ', num2str(Best_score),newline];
        
         app.TextArea.Value=tas;
       
    if iter>2 
        line(curve,[iter-1 iter], [cg_curve(iter-1) cg_curve(iter)],'Color','r','LineWidth',2);
        drawnow;
    end
